...
import { increamentPostLike } from '@/config/redux/action/postAction'
                ...
                <div className={styles.wrapper}>
                    ...
                    <div className={styles.createPostContainer}>
                        {authState.profileFetched && authState.user?.userId?.profilePicture ? (
                            ...
                            <img className={styles.userProfile} width={100} src={`${BASE_URL}/${authState.user.userId.profilePicture}`} alt="Profile" />
                        ) : (
                            <p>No profile picture</p>
                        )}

                        <textarea onChange={(e) => setPostContent(e.target.value)} value={postContent} className={styles.textArea} placeholder={"what's in your mind?"} name='' id=''></textarea>
                        <label htmlFor='fileUpload'>
                            <div className={styles.Fab}>
                                <svg style={{padding: "0.4rem"}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                            ...
                            return (
                                <div key={post._id} className={styles.singleCard}>
                                    ...
                                    <div className={styles.singleCard_profileContainer}>
                                        ...
                                        }} style={{cursor: "pointer"}} className={styles.userProfile} src={`${BASE_URL}/${post.userId.profilePicture}`} alt="Profile" />
                                        ...
                                        <div>
                                            ...
                                            <div className={styles.optionsContainer}>
                                                ...
                                                <div onClick={async () => {
                                                    await dispatch(increamentPostLike({ post_id: post._id }))
                                                    dispatch(getAllPosts());
